using PREVEBSAPlanSettingsClassLibrary.Response;
using PREVEBSAPlanSettingBackend.Repositories.Interfaces;
using PREVEBSAPlanSettingBackend.UnitsOfWork.Interfaces;
using PREVEBSAPlanSettings.Dtos.Dtos;

namespace PREVEBSAPlanSettingBackend.UnitsOfWork.Implementations
{
    public class GenericUnitOfWork<T> : IGenericUnitOfWork<T> where T : class
    {
        ...
        public virtual async Task<ActionResponse<T>> DeleteByGuidAsync(Guid id) => await _repository.DeleteByGuidAsync(id);
        ...
        public virtual async Task<ActionResponse<T>> GetByGuidAsync(Guid id) => await _repository.GetByGuidAsync(id);
    }
}
